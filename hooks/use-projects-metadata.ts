...
export function useProjectsMetadata() {
	...
	useEffect(() => {
		const updateMetadata = () => {
			...
			if (title) {
				title.textContent = t("projects.title", { ns: "metadata" })
			}
			...
			if (metaDescription) {
				metaDescription.setAttribute(
					"content",
					t("projects.description", { ns: "metadata" })
				)
			}
			...
			if (ogTitle) {
				ogTitle.setAttribute(
					"content",
					t("projects.ogTitle", { ns: "metadata" })
				)
			}
			...
			if (ogDescription) {
				ogDescription.setAttribute(
					"content",
					t("projects.ogDescription", { ns: "metadata" })
				)
			}
			...
			if (twitterTitle) {
				twitterTitle.setAttribute(
					"content",
					t("projects.twitterTitle", { ns: "metadata" })
				)
			}
			...
			if (twitterDescription) {
				twitterDescription.setAttribute(
					"content",
					t("projects.twitterDescription", { ns: "metadata" })
				)
			}
